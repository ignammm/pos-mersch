    ...
    <div class="mb-8">
        <div class="flex items-center gap-4 mb-4">
            <button onclick="window.location.href='{{ route('ventas.index') }}'" 
                ...
                <svg class="w-5 h-5 text-gray-600 group-hover:text-blue-600 transition-colors" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div>
                ...
                <div class="relative">
                    <input wire:model="codigo_barra" 
                           wire:keydown.enter="agregarArticulo"
                           type="text" 
            ...
            <div>
                ...
                <input wire:model.live="cantidad" 
                       type="number" 
            ...
            <div>
                ...
                <div class="relative">
                    <input wire:model.live="descuento"
                           type="number"
                           ...
                           max="100"
                           placeholder="0">
                    <span class="absolute inset-y-0 right-4 flex items-center text-gray-500 font-medium pointer-events-none">%</span>
                </div>
            </div>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <span class="w-12 text-center font-semibold text-gray-900">{{ $item['cantidad'] }}</span>
                                    <button 
                            ...
                            <td class="px-6 py-4 text-right font-semibold text-gray-900">${{ number_format($item['precio_unitario'], 0) }}</td>
                            <td class="px-6 py-4 text-right">
                                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium {{ $item['descuento_unitario'] > 0 ? 'bg-red-100 text-red-800' : 'bg-gray-100 text-gray-800' }}">
                                    {{ number_format($item['descuento_unitario'], 0) }}%
                                </span>
                            </td>
                            <td class="px-6 py-4 text-right font-semibold text-green-600">${{ number_format($item['subtotal'], 0) }}</td>
